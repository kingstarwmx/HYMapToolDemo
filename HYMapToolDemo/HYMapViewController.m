...
#define MAPHEIGHT [UIScreen mainScreen].bounds.size.height
...
//    [_search AMapPOIAroundSearch: _request];
    ...
    _searchController.searchBar.frame = CGRectMake(0, 0, screenSize.width, 44.0);
    ...
    //初始化tableView
    _listTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, SEACHBARHEIGHT + MAPHEIGHT, screenSize.width, screenSize.height - SEACHBARHEIGHT - MAPHEIGHT - 64) style:UITableViewStylePlain];
...
//    _mapView.frame = CGRectMake(0, SEACHBARHEIGHT, CGRectGetWidth(self.view.bounds), MAPHEIGHT);
